...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>PSW - Off the shelf</title>
         <link rel="stylesheet" type="text/css" href="css/offtheshelf.css">
    ...
    <body id="offtheshelf">
        ...
        <div id="container">
            ...
            <?php include("products/thumbnail/truegrit.php");?>
            <?php include("products/thumbnail/honeysuckle.php");?>
            <?php include("products/thumbnail/pine.php");?>
        </div>
    </body>
</html>